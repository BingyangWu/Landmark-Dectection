...
model_urls = {
    ...
    "resnet34": "https://download.pytorch.org/models/resnet4-333f7ec4.pth",
...
class BasicBlock(nn.Module):
    ...
    def __init__(
        self, inplanes, planes, stride=1, downsample=None, layer_normalization="batch"
    ):
    ...
    def _make_layer(self, block, planes, blocks, stride=1):
        ...
        layers.append(
            block(
                ...
                stride,
                downsample,
                layer_normalization=self.layer_norm,
            )
        )
        self.inplanes = planes * block.expansion
        for i in range(1, blocks):
            layers.append(
                block(self.inplanes, planes, layer_normalization=self.layer_norm)
            )
