...
def get_dataset_paths(dsname):
    ...
    return check_paths(
        _paths.__getattribute__(dsname), _paths.__getattribute__(dsname + "_local")
    )
...
RHPE_MEAN, RHPE_STD = 0.5853984604992433, 1  # 0.1699945412688975
RHPE_NORMALIZER = Normalizer(RHPE_MEAN, RHPE_STD)
